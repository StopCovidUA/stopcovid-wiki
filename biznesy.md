...
Координатор: нужен координатор \(напишите [Максу](http://t.me/maxsemenchuk)\)
...
* [https://untwist.io/](https://untwist.io/) - поможет вам отслеживать все ваши заметки о встречах по всем вашим проектам - и это совершенно бесплатно во время кризиса.
* Многие считают, что [Zoom](https://zoom.us/)  - лучший вариант на данное время. Вы можете использовать его бесплатно для 100 человек на срок до 40 минут \(затем вы можете перезапустить звонок  и использовать это время для кофе-брейка!\)
* Онлайн-конференции / мероприятия с комнатами обсуждения, где участники могут перемещаться, используя Zoom + Google Docs + профили пользователей:[example event on QiqoChat](https://qiqochat.com/e/bfAzdiJjsPpomrZWrbhELQzJk)
* [Jitsi](http://jitsi.org/) - похож на Zoom и полностью бесплатен, но имеет некоторые ограничения браузера с Safari и Firefox \([link](https://github.com/jitsi/lib-jitsi-meet/blob/fa24ac5289c5e73b2f5d4fe005cef8f9cfff8268/modules/browser/capabilities.json)\).
* [8X8](http://8x8.com/) - сейчас принадлежит [Jitsi](http://jitsi.org/) и работает аналогично
* [Team.video](https://team.video/) - работает в бета-версии, но утверждает, что работает во всех основных браузерах, не требуя загрузки, имеет отличные функции «повестки дня» и «заметки», бесплатно для 15 человек
* Microsoft Teams бесплатна до 300 человек: [https://products.office.com/microsoft-teams/group-chat-software](https://products.office.com/microsoft-teams/group-chat-software)
* [https://www.hugo.team/](https://www.hugo.team/)
* Google Hangouts будет работать для небольших групп \(как правило, до 25 команд\), но его пропускная способность будет перегружена, если слишком много участников.
* Google JamBoards хороши для виртуальных сессий идей.
* [Whereby.com](https://whereby.com/) - это простая альтернатива.
* [Vectera.com](https://www.vectera.com/) - браузерный инструмент для видеоконференций Полностью бесплатный до 1 июня.
* [Konf.co](https://konf.co/) - это платформа для онлайн-конференций, которая скоро будет запущена.
* Slack \([https://slack.com/](https://slack.com/)\) - хорошая платформа для обмена сообщениями, звонков, обмена экранами, обмена документами. 
* Cisco WebEx бесплатен для личного использования с 12.03.2020 [https://www.webex.com/pricing/index.html](https://www.webex.com/pricing/index.html)
* Nextcloud talk проводит видеоконференции и работает на своих серверах [https://nextcloud.com](https://nextcloud.com/)
* BigBlueButton - это приложение для веб-конференций с открытым исходным кодом, предназначенное для обучения - [https://bigbluebutton.org/](https://bigbluebutton.org/)
* В Википедии есть хороший список сравнения вариантов веб-конференций. [https://en.wikipedia.org/wiki/Comparison\_of\_web\_conferencing\_software](https://en.wikipedia.org/wiki/Comparison_of_web_conferencing_software)
...
* [http://leapers.co/go/coronavirus](http://leapers.co/go/coronavirus) – Сообщество, поддерживающее психическое здоровье людей, работающих на себя. Собирает и обменивается ресурсами для обеспечения позитивного психического здоровья, связанного с удаленной работой, работой в условиях изоляции, а также для тех людей,  которые могут потерять бизнес из-за коронавируса. 

Борьба с выгоранием, изоляцией и беспокойством на удаленном рабочем месте
