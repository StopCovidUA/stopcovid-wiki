...
* **Людям, які не можуть дотримуватися  карантину через роботу \(медичний персонал, поліція, прицівники продуктових магазинів, аптек і т.п.\)**
...
{% hint style="info" %}
ГО «[Інститут медико-соціальних проблем вразливих категорій населення](http://ukrims.org/)» спільно з волонтерами руху  StopCovidUА організовує кризове психологічне консультування через платформу УКРІМС.
{% endhint %}
...
Навчання для волонтерів безкоштовне. Воно складається з 12 блоків по 1,5 години. 

**Щоб приєднатися до навчання на програмі, потрібно:**

* Надати інформацію про ваше профільне психологічне навчання та досвід роботи; 
* Повідомити, яку кількість годин ви зможете присвячувати роботі на гарачій лінії \(**це можуть бути навіть 1-2 години на тиждень, але ви маєте бути готові фокусуватися лише цій роботі у визначений час**\).
...
{% hint style="danger" %}
Заявки на навчання приймаються до 06.04.2020.
{% endhint %}
...
якщо у вас є контакти, яких немає у списку, але які можут допомогти в реалізації проектів, додайте їх, будь ласка.
